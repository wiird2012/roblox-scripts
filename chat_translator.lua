...
function googleConsent(Body) -- Because google really said: “no”
    local args = {}
...
local function got(url, Method, Body) -- Basic version of https://www.npmjs.com/package/got using request API for google websites
